...
namespace DevIO.App.Controllers
{
    ...
    public class ProdutosController : BaseController
    {
        ...
        public ProdutosController(IProdutoRepository produtoRepository, IMapper mapper, IFornecedorRepository fornecedoreRepository)
        {
        ...
        private async Task<ProdutoViewModel> ObterProduto(Guid id)
        {
            ...
            produto.Fornecedores = _mapper.Map<IEnumerable<FornecedorViewModel>>(await _fornecedoreRepository.ObterTodos());
